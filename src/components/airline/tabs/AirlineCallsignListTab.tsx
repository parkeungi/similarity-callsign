...
export function AirlineCallsignListTab({
  ...
  const dateFilteredCallsigns = useMemo(() => {
    if (uploadBatchActive) return airlineCallsigns;
  ...
  }, [airlineCallsigns, dateFilter.startDate, dateFilter.endDate, uploadBatchActive]);
        ...
        <div className="flex w-full items-center gap-2">
          ...
          {viewMode === 'batch' && hasBatch && (
            <>
              ...
              >
                {uploadBatch!.availableYMs.length === 0
          ...
          */}
          ...
          <button
            ...
            className="h-7 px-2.5 text-[11px] font-bold bg-green-600 text-white hover:bg-green-700 disabled:bg-gray-300 shrink-0 transition-colors rounded"
          >
            {isExporting ? '...' : 'EXCEL'}
          </button>
        </div>
